...
nav_card(col5, "📖", "Study Guide",
         "7-day plan · Questions · Reflections",
         "📖 Open Study Guide", "btn_study",
         "pages/11_Study_Guide.py")
nav_card(col6, "🙏", "Satsang Guide",
         "Discussion questions for study groups",
         "🙏 Open Satsang Guide", "btn_satsang",
         "pages/13_Satsang_Discussion.py")

st.markdown("<br/>", unsafe_allow_html=True)

# ── Row 3: Reference tools ────────────────────────────────────────────────────
col7, col8, col9 = st.columns(3)
nav_card(col7, "🕉️", "Sanskrit Verse Lookup",
         "Identify any verse from any scripture",
         "🕉️ Open Verse Lookup", "btn_sanskrit",
         "pages/12_Sanskrit_Verse_Lookup.py")
nav_card(col8, "📄", "Document Combiner",
