...
custom_prompt = st.text_area(
    ...
    placeholder=(
        "Examples:\n"
        "• Highlight the areas where Swamiji has stressed key points\n"
        "• Identify all places where other scriptural texts are referenced\n"
        "• Flag all analogies and stories used to explain concepts\n"
        "• Mark all Sanskrit terms and provide their meanings"
    ),
