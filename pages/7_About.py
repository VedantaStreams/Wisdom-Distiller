...
professional journey has been in the fields of Physics, academia, Data Science, Machine
Learning, and Generative AI, my deepest inspiration continues to come from the study of
Vedānta and the lifelong path of spiritual learning.</p>
...
<b style="color:#b8a88a;">PhD in Physics from IISc Bangalore</b>. I spent more than
<b style="color:#b8a88a;">15 years as a faculty in the College of Engineering at
Northern Illinois University</b>, where I had the privilege of teaching, mentoring students,
and engaging in research. I now serve as a
<b style="color:#b8a88a;">Senior Data Scientist / AI Engineer at Capital One</b>,
working at the intersection of machine learning, generative AI, and enterprise data science.
These experiences have shaped my appreciation for knowledge, inquiry, discipline, and the
...
with the guidance of revered teachers through
<b style="color:#b8a88a;">Chinmaya Mission</b>, continue to shape my understanding of
life, knowledge, purpose, and seva.</p>

<p>This humble initiative was born from a simple and heartfelt desire — to use the tools
of modern AI in service of preserving, organizing, and making sacred discourse wisdom more
accessible to seekers. The purpose of this app is to assist seekers in
<b style="color:#b8a88a;">transcribing discourses</b>, generating summaries for reflection
and note-taking, <b style="color:#b8a88a;">extracting meaningful quotes and insights</b>,
and making these teachings accessible across different languages and formats.</p>
