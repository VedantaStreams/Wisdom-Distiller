...
/* Home button fix */
[data-testid="stSidebarNav"] li:first-child a span:last-child::before { content: "Home"; position: absolute; }
[data-testid="stSidebarNav"] li:first-child a span:last-child { font-size: 0; position: relative; }
...
/* Nav cards */
.nav-card { background: #111; border: 1px solid #2a2a2a; border-radius: 12px; padding: 1.4rem 1.6rem; cursor: pointer; transition: all 0.2s ease; text-align: center; }
.nav-card:hover { border-color: #c9a96e; background: #161616; }
</style>
"""
