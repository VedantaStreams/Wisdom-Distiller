...
def structure_transcript(raw: str, anthropic_key: str,
    ...
    if custom_prompt and custom_prompt.strip():
        custom_note = (
            ...
            "==============================================================\n"
            + custom_prompt.strip()
            + "\n\nWhen any of the above apply, mark them clearly inline using bold labels:\n"
            "**[KEY EMPHASIS]** — areas the teacher stressed\n"
            "**[CROSS-REFERENCE: Scripture Name]** — references to other texts\n"
            "**[ANALOGY]** — stories or examples used to explain concepts\n"
            "**[SANSKRIT TERM: meaning]** — key Sanskrit terms explained\n"
        )
